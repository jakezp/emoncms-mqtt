...
if [[ ! -d $INDEX ]]; then
  ...
  #git clone https://github.com/emoncms/emailreport.git /home/pi/emailreport
  ...
  #ln -s /home/pi/emailreport/emailreport-module /var/www/html/Modules/emailreport
